...
describe("drag and drop", () => {
  ...
  it("should successfuly relocate buns", () => {
    ...
    cy.get(".constructor-element__text").eq(0).should('have.text', `${ingredients.data[0].name} (верх)`)
    cy.get(".constructor-element__text").eq(1).should('have.text', `${ingredients.data[0].name} (низ)`)
});
